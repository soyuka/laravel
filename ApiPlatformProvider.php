...
class ApiPlatformProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        ...
        $this->app->extend(PropertyMetadataFactoryInterface::class, function (PropertyInfoPropertyMetadataFactory $inner, Application $app) {
            return new EloquentPropertyMetadataFactory($app, new SerializerPropertyMetadataFactory(
        ...
        $this->app->bind(ProcessorInterface::class, WriteProcessor::class);
        ...
        $this->app->singleton(JsonLdObjectNormalizer::class, function (Application $app) use ($defaultContext) {
        ...
        $this->app->singleton(EntrypointAction::class, function(Application $app) use ($docsFormats) {
    ...
    public function boot(ResourceNameCollectionFactoryInterface $resourceNameCollectionFactory, ResourceMetadataCollectionFactoryInterface $resourceMetadataFactory, Router $router): void
    {
        if ($this->app->runningInConsole()) {
            ...
            // Load swagger UI view
            // $this->publishes([
            //     __DIR__.'/resources/views' => resource_path('views/vendor/api-platform'),
            // ]);
