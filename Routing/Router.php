...
final class Router implements RouterInterface, UrlGeneratorInterface
{
    ...
    public function __construct(private readonly BaseRouter $router, private readonly int $urlGenerationStrategy = self::ABS_PATH)
    {
    }
    ...
    {
        return $this->router->getRoutes()->toSymfonyRouteCollection();
    }
